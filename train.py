...
def parse_args():
    ...
    parser.add_argument('--master_port', type=int, default=12345, help='address')
    parser.add_argument('--local_rank', default=0, type=int, help='local rank')

    ## dataset
    parser.add_argument("--paths_file", type=str, default="./data/train.txt",
    ...
    parser.add_argument("--val_paths_file", type=str, default="./data/val.txt", help="path to the validation set")
    ...
    parser.add_argument("--batch_size", type=int, default=16,
                        help="size of the batches")  # no default value given by paper,guess as 64
...
def predict_loss(args, data, model,
    ...
    #shape = in_edges.shape
    #in_edges = in_edges.reshape([shape[0], shape[2], shape[3]])
...
def train(args, global_rank, sync, get_module,
    ...
    for epoch in range(args.cond_epoch, args.n_epochs):
        ...
        for step, data in enumerate(dataloader):
            ...
            loss, weighted_loss_seg, weighted_loss_clf, weighted_loss_edg, in_imgs, in_masks, in_edges, out_masks, out_edges = predict_loss(
